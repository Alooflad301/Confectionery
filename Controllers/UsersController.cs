...
namespace Confectionery.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            ViewData["Id_Role"] = new SelectList(_context.Roles, "Id_Role", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_User,Login,Name,Id_Role,Password,Email")] User user)
        {
            var existingUser = _context.Users
           .FirstOrDefault(u => u.Email == user.Email || u.Login == user.Login);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_User,Login,Name,Id_Role,Password,Email")] User user)
        {
            if (id != user.Id_User)
            {
                return NotFound();
