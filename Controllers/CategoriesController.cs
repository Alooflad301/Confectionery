...
namespace Confectionery.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Category,Name")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Category,Name")] Category category)
        {
